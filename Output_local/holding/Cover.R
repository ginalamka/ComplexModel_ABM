...
setwd("/scratch/glamka/ABM_run.10.12.22_d/01") #("C:/Users/ginab/Box/New Computer/Auburn/Data/ComplexModel_ABM")  
directory = getwd()
...
write.table(theEND, paste(directory, "/Output/summary_ABM_run.10.12.22_d_01.csv", sep=""), sep=",", col.names=TRUE, append=FALSE, quote=FALSE, row.names=FALSE)
write.table(repEND, paste(directory, "/Output/rep_summary_ABM_run.10.12.22_d_01.csv", sep=""), sep=",", col.names=TRUE, append=FALSE, quote=FALSE, row.names=FALSE)
