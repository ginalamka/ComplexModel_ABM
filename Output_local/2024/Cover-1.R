...
setwd("/scratch/glamka/p_2.20.24_LL3a_mi/20") # setwd("C:/Users/ginab/Box/New Computer/Auburn/Data/ComplexModel_ABM/ABM_sep2022") 
directory = getwd()
...
write.table(parameters, paste(directory, "/Output/parameters_p_2.20.24_LL3a_mi_20.csv", sep=""), sep=",", col.names=TRUE, append=FALSE, quote=FALSE, row.names=FALSE)
...
mu            = 0.0000000022  #mutation rate in noncoding SNPs #(2.2 x 10^-9) #https://www.ncbi.nlm.nih.gov/pmc/articles/PMC117386/
mu_co         = 0.00000000048 #deleterious mutation rate in coding SNPs #4.84 X10^-10 = 2.2x10^-9*.22 constraint #https://www.ncbi.nlm.nih.gov/pmc/articles/PMC263826/
purge         = 1    #1=yes, 0=no
...
write.table(theEND, paste(directory, "/Output/summary_p_2.20.24_LL3a_mi_20.csv", sep=""), sep=",", col.names=TRUE, append=FALSE, quote=FALSE, row.names=FALSE)
write.table(repEND, paste(directory, "/Output/rep_summary_p_2.20.24_LL3a_mi_20.csv", sep=""), sep=",", col.names=TRUE, append=FALSE, quote=FALSE, row.names=FALSE)
